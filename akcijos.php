...
<div id="wrapper">
  ...
  <div class="innerbg"> 
     ...
     <div class="innerleft">
       <div class="product_division"><img src="images/akcijos.jpg" alt="" border="0" /></div>
       ...
       <div class="innercontentleft">         
         ...
         <a class="fontbold" href="#">Būsto signalizacijos komplektas 500LT</span></a><br />
         &nbsp;</div>       
       </div>
     ...
     <div class="innercontent">
       ...
       <div class="inner_product_service_head"><img src="images/akcijos_head.jpg" alt="" border="0" /></div>
       
      

	  <div class="main_con">
        <iframe name="antras" src="tiny4.php"  style="width: 509px; height: 603px"  ></iframe>        
       </div>
